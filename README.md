...
L'application est alimentée par des fichiers JSON situés dans le dossier assets/. Au démarrage, le DataSyncService lit ces fichiers et met à jour la base locale Hive.
...
Contenu Médical : Divers sources à préciser à l'avenir
